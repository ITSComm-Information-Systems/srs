...
def e911(request):
    ...
    phone_numbers = ZoomAPI.objects.filter(dept_id__in=department_list, default_address=True).order_by('dept_id','username').values('username','dept_id','phone_number')
